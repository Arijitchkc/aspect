 ...
 * and the advection of fluids. It is designed to be composited with another
 * material model that computes the solid material properties.
...
private:
   ...
   * Pressure-Temperature conditions, and releasing bound water as free water
   * if: (maximum bound water content < current bound water content) or
   * incorporating free water (if present) into the solid phase as bound water:
   * maximum bound water content > current bound water content
   * This model requires that 4 compositional fields named after the 4 different
   * rock types exist in the input file.
   *
